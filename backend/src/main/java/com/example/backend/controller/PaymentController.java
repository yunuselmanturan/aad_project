...
public class PaymentController {
    ...
    @GetMapping("/get-payment-intent/{orderId}")
    public ResponseEntity<ApiResponse<Map<String, String>>> getPaymentIntent(@PathVariable Long orderId) {
        String clientSecret = paymentService.getExistingPaymentIntent(orderId);
        return ResponseEntity.ok(ApiResponse.success(Map.of("clientSecret", clientSecret)));
    }
